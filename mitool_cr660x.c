...
static void usage(void)
{
	...
	fprintf(stderr, "\tlock mtd2 and auto reboot\n");
	fprintf(stderr, "mitool unlock\n");
	fprintf(stderr, "\tunlock mtd2 and auto reboot\n");
